    ...
    <div class="container w-75 mt-5 rounded shadow">
        <div class="row align-items-strech mt-5">
            <div class="col rounded shadow-sm border p-3">
                <img class="img-pedido" src="imagenes/pedido.png" alt="">
                <a class="btn btn-primary d-grid" href="form-pedido.php">Pedido</a>
            </div>
            <div class="col rounded shadow-sm border p-3">
                <img class="img-cita" src="imagenes/cita.png" alt="">
                <a class="btn btn-primary d-grid" href="form-cita.php">Cita</a>
            </div>
            <div class="col rounded shadow-sm border p-3">
                <img class="img-transporte" src="imagenes/transporte.png" alt="">
                <a class="btn btn-primary d-grid" href="form-transporte.php">Transporte</a>
            </div>
        </div>
    </div>
