        ...
        ?>
            ...
            <div class="row p-2 ">
                ...
                ?>
                    ...
                    if (mysqli_num_rows($resultado3) > 0) {
                        ...
                        ?>
                            ...
                            if (mysqli_num_rows($resultadoA) > 0) {
                                ...
                                if (mysqli_num_rows($resultadoR) > 0) {
                                    ...
                                    if (mysqli_num_rows($resultadoE) > 0) {
                                        ...
                                        <div class="col rounded shadow-sm border p-3">
                                             <a href="form-entrega.php" class="btn btn-danger">SIN ENTREGA</a>
                                        </div>
                                    <?php
                                    }
                                } else {
                                    ?>
                                    <div class="col rounded shadow-sm border p-3">
                                        <a href="form-reparto.php" class="btn btn-danger">SIN REPARTO</a>
                                    </div>
                                <?php
                                }
                            } else {
                                ?>
                                <div class="col rounded shadow-sm border p-3">
                                    <a href="form-carga.php" class="btn btn-danger">SIN CARGA</a>
                                </div>
                        <?php
                            }
                        }
                        ...
                        ?>
                        <div class="col rounded shadow-sm border p-3">
                            <a href="#" class="btn btn-danger">SIN TRANSPORTE</a>
                        </div>
                    <?php
                    }
                } else {
                    ?>
                    <div class="col rounded shadow-sm border p-3">
                        <a href="#" class="btn btn-danger">SIN CITA</a>
                    </div>
                <?php
                }
